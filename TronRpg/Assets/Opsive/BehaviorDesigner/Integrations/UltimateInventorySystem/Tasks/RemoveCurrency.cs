...
namespace Opsive.BehaviorDesigner.Integrations.UltimateInventorySystem
{
    ...
    public class RemoveCurrency : TargetGameObjectAction
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            return m_CurrencyOwner.CurrencyAmount.RemoveCurrency(m_CurrencyAmounts.Value) ? TaskStatus.Success : TaskStatus.Failure;
        }
