...
namespace Opsive.BehaviorDesigner.Integrations.UltimateInventorySystem
{
    ...
    public class HasItemWithDefinition : TargetGameObjectConditional
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (itemCollection != null) {
                return itemCollection.HasItem((m_ItemDefinition.Value, m_Amount.Value), m_CheckInherently.Value, m_CountStacks.Value) ? TaskStatus.Success : TaskStatus.Failure;
            }

            return m_Inventory.HasItem((m_Amount.Value,m_ItemDefinition.Value), m_CheckInherently.Value, m_CountStacks.Value) ? TaskStatus.Success : TaskStatus.Failure;
        }
